  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { target: "belok", en: "to turn (left/right)", kind: "vocab" },
        { target: "jalan", en: "street / to walk", kind: "vocab", note: "As a verb, walking is usually berjalan or jalan kaki; jalan alone for walk is colloquial." },
    ...
    },
    {
      ...
      items: [
        ...
        { target: "Pasar dekat dengan rumah saya.", en: "The market is near my house.", kind: "sentence" },
