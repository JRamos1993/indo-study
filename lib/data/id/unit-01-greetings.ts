  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { target: "tolong", en: "please / help", kind: "vocab" },
        { target: "silakan", en: "please (go ahead)", kind: "vocab" },
        { target: "ya", en: "yes", kind: "vocab" },
        { target: "tidak", en: "no / not", kind: "vocab" },
        { target: "bukan", en: "no / not (with nouns)", kind: "vocab" },
