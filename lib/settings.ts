...
export interface Settings {
  ...
  dailyGoal: number;
  dailyGoalMinutes: number; // 5 | 10 | 15 | 30 (onboarding/profile preset)
  newPerDay: number;
...
const FOCI: LearningFocus[] = ["balanced", "conversation", "reading", "grammar"];
...
function normalize(raw: unknown): Settings {
  ...
  return {
    ...
    learningFocus: FOCI.includes(focus as LearningFocus) ? (focus as LearningFocus) : DEFAULT_SETTINGS.learningFocus,
