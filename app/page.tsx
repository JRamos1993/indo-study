...
const FEATURES: { icon: IconName; title: string; body: string; tint: string; shadow: string }[] = [
  ...
  { icon: "bolt", title: "Works offline", body: "Installable as an app. Your progress lives on your device — no account.", tint: "var(--tint-coral)", shadow: "var(--lilt-coral)" },
];
  ...
  return (
    <div className="pb-10">
      ...
      <section className="mt-12">
        ...
        <div className="card p-5" style={{ borderRadius: "var(--r-card)", boxShadow: "4px 4px 0 0 var(--edge)" }}>
          <p className="text-[14px] font-bold" style={{ color: "var(--text-body)" }}>
