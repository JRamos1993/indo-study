  ...
  sections: [
    {
      ...
      items: [
        { target: "saya", en: "I / me (polite)", kind: "vocab", note: "saya is the safe, polite “I” for any situation. aku is casual — for close friends and family." },
        { target: "aku", en: "I / me (casual)", kind: "vocab", note: "aku is casual “I”, for friends and family. With strangers or to be polite, use saya." },
        { target: "kamu", en: "you (casual)", kind: "vocab", note: "kamu is casual “you”, for friends and peers. For respect or strangers, use Anda." },
        { target: "Anda", en: "you (formal)", kind: "vocab", note: "Anda is formal “you” (always capitalised), for strangers and respect. kamu is the casual form." },
