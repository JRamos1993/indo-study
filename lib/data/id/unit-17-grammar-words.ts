...
export const lesson: RawLesson = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        { target: "sudah", en: "already / done", kind: "vocab", note: "sudah = “already / done”. Its opposite is belum (not yet) — not tidak." },
        { target: "belum", en: "not yet", kind: "vocab", note: "belum = “not yet” (it just hasn't happened): “saya belum makan”. tidak is a plain “not”; sudah is its opposite." },
    ...
    },
    {
      ...
      items: [
        ...
        { target: "boleh", en: "may / allowed", kind: "vocab", note: "boleh = “may / allowed” (permission): “boleh saya masuk?”. For ability (“can”), use bisa." },
        ...
        { target: "ini", en: "this", kind: "vocab", note: "ini = “this” (near you). itu = “that” (away from you). They come after the noun: “buku ini” (this book)." },
        { target: "itu", en: "that", kind: "vocab", note: "itu = “that” (away from you). ini = “this” (near). They follow the noun: “orang itu” (that person)." },
